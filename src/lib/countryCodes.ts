// Maps the exact country names used in src/components/checkout-widget/steps/
// shipping-step.tsx's COUNTRIES dropdown to ISO 3166-1 alpha-2 codes - the
// real payment endpoint requires countryISO2, not a full country name (see
// cardEncryption.ts). Keep this list in sync with that dropdown.
const NAME_TO_ISO2: Record<string, string> = {
  ...
  Kenya: "KE", Kiribati: "KI", "Korea, North": "KP", "Korea, South": "KR",
